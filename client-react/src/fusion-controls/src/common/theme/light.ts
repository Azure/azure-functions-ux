...
const semanticColors = {
  ...
  //disabledText: AzurePortalColors.disabledText, //This and the others commented out were to fix a "always overwritten" error thrown by TS compiler
  ...
  // The properties below were required by the SemanticColorsExtended interface but not present
