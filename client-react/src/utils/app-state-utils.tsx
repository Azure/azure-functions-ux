...
import { isCentauriApp, isContainerApp, isElastic, isFunctionApp, isKubeApp, isLinuxApp, isLinuxDynamic } from './arm-utils';
...
function resolveStateFromSite(site: ArmObj<Site>, appSettings?: ArmObj<AppSettings>) {
  ...
  if (isContainerApp(site) || isCentauriApp(site)) {
