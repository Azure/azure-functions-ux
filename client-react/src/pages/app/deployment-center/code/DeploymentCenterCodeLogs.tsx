...
const DeploymentCenterCodeLogs: React.FC<DeploymentCenterCodeLogsProps> = props => {
  ...
  const getDeploymentRow = (deployment: ArmObj<DeploymentProperties>, index: number): CodeDeploymentsRow => {
    return {
      ...
      author: deployment.properties.author && deployment.properties.author !== 'N/A' ? deployment.properties.author : '',
  ...
  const columns: IColumn[] = [
    ...
    { key: 'commit', name: t('commitId'), fieldName: 'commit', minWidth: 75, maxWidth: 150 },
    { key: 'author', name: t('Author'), fieldName: 'author', minWidth: 100, maxWidth: 150 },
    { key: 'status', name: t('status'), fieldName: 'status', minWidth: 100, maxWidth: 200 },
