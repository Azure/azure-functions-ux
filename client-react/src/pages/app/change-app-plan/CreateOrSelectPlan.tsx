...
export const CreateOrSelectPlan = (props: CreateOrSelectPlanFormValues & CreateOrSelectPlanProps & IDropdownProps) => {
  ...
  const onChangeDropdown = (_e: unknown, option: IDropdownOption) => {
    const info = { ...planInfo };
