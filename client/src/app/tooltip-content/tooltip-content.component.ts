...
export class TooltipContentComponent implements AfterViewInit {
  ...
  show(): void {
    ...
    this.left = p.left;
    this.isIn = true;
    if (this.animation) this.isFade = true;
  }
  ...
  hide(): void {
    ...
    this.left = -100000;
    this.isIn = true;
    if (this.animation) this.isFade = false;
  }
  ...
  private getStyle(nativeEl: HTMLElement, cssProp: string): string {
    ...
    if (window.getComputedStyle) return (window.getComputedStyle(nativeEl) as any)[cssProp];
