        ...
        return _cacheService
          ...
          .concatMap(r => {
            ...
            if (currentProject) {
              ...
              return _cacheService
                .get(`https://${vstsAccountValue}.vsrm.visualstudio.com/${currentProject.id}/_apis/Release/definitions`, true, callHeaders)
                .switchMap(() => {
                  return Observable.forkJoin(
                    _cacheService.get(
                      `https://${vstsAccountValue}.visualstudio.com/_apis/Permissions/${DeploymentCenterConstants.buildSecurityNameSpace}/${
