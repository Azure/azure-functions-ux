  ...
  getSpecCosts() {
    ...
    return this._getBillingMeters(this._inputs)
      .switchMap(meters => {
        ...
        this.specGroups.forEach(g => {
          g.recommendedSpecs.forEach(s => this._setBillingResourceIdAndQuantity(s, meters, includeJbossCost));
          g.additionalSpecs.forEach(s => this._setBillingResourceIdAndQuantity(s, meters, includeJbossCost));
