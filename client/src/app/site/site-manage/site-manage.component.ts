        ...
        networkFeatures.push(
          new BladeFeature(
            ...
            'image/msi.svg',
            {
              ...
              detailBladeInputs: {
                resourceId: site.id,
                apiVersion: ARMApiVersions.websiteApiVersion20181101Was20180201,
...
export class OpenKuduFeature extends DisableableFeature {
  ...
  click() {
    const scmHostName = this._site.properties.hostNameSslStates.find(h => h.hostType === HostTypes.Repository).name;
