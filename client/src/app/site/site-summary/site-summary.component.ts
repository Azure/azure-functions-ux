...
import { Site, SiteAvailabilityStates } from '../../shared/models/arm/site';
...
export class SiteSummaryComponent extends FeatureComponent<TreeViewInfo<SiteData>> implements OnDestroy {
  ...
  protected setup(inputEvents: Observable<TreeViewInfo<SiteData>>) {
    return inputEvents
      ...
      .switchMap(context => {
        ...
        this.siteAvailabilityStateNormal = context.site.properties.availabilityState === SiteAvailabilityStates.Normal;
  ...
  private _setAppState(context: FunctionAppContext) {
    if (context.site.properties.availabilityState !== SiteAvailabilityStates.Normal) {
