...
export class ArmTryService extends ArmService {
  ...
  private _whiteListedPrefixUrls: string[] = [`${Constants.serviceHost}api`, 'assets/schemas'];

  constructor(http: Http, userService: UserService, portalService: PortalService, aiService: AiService) {
