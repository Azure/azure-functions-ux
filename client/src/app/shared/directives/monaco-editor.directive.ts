...
export class MonacoEditorDirective {
  ...
  @Output()
  public onFileChanged: Subject<void>;
  @Output()
  public onSave: EventEmitter<string>;
  @Output()
  public onRun: EventEmitter<void>;
  ...
  setMonacoSchema(schemaName: string) {
    this._cacheService.get('assets/schemas/' + schemaName).subscribe((schema: any) => {
