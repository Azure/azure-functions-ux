...
export class NoCorsHttpService {
  ...
  request(url: string, options: RequestOptionsArgs, force?: boolean): Observable<Response> {
    ...
    return this._cacheService
      .send(url, options.method as string, force, options.headers, options.body)
  ...
  get(url: string, options?: RequestOptionsArgs, force?: boolean): Observable<Response> {
    return this._cacheService
      .get(url, force, options && options.headers ? options.headers : new Headers())
  ...
  post(url: string, body: any, options?: RequestOptionsArgs): Observable<Response> {
    return this._cacheService
      .post(url, true, options && options.headers ? options.headers : new Headers(), body)
  ...
  put(url: string, body: any, options?: RequestOptionsArgs): Observable<Response> {
    return this._cacheService
      .put(url, options && options.headers ? options.headers : new Headers(), body)
  ...
  delete(url: string, options?: RequestOptionsArgs): Observable<Response> {
    return this._cacheService
      .delete(url, options && options.headers ? options.headers : new Headers())
  ...
  patch(url: string, body: any, options?: RequestOptionsArgs): Observable<Response> {
    return this._cacheService
      .patch(url, options && options.headers ? options.headers : new Headers())
  ...
  head(url: string, options?: RequestOptionsArgs, force?: boolean): Observable<Response> {
    return this._cacheService
      .head(url, force, options && options.headers ? options.headers : new Headers())
  ...
  options(url: string, options?: RequestOptionsArgs, force?: boolean): Observable<Response> {
    return this._cacheService
      .options(url, force, options && options.headers ? options.headers : new Headers())
  ...
  tryPassThroughController(
    ...
    if (error.status === 0 && error.type === ResponseType.Error) {
      this.passThrough(method, url, body, options);
    } else {
      throw error;
    }
  }
