...
import { LogCategories, ScenarioIds, ARMApiVersions } from './../shared/models/constants';
...
export class AppsNode extends TreeNode implements MutableCollection, Disposable, Refreshable {
    ...
    private _doSearch(
        ...
        const subsBatch = subscriptions.slice(subsIndex, subsIndex + ARMApiVersions.MaxSubscriptionBatchSize);
        ...
        return this.sideNav.cacheService.get(url, false, null, true)
            ...
            .switchMap(r => {
                ...
                if (result.nextLink || (subsIndex + ARMApiVersions.MaxSubscriptionBatchSize < subscriptions.length)) {
                    return this._doSearch(
                        children,
                        term,
                        subscriptions,
                        subsIndex + ARMApiVersions.MaxSubscriptionBatchSize,
                        result.nextLink);
                } else {
