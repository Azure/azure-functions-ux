...
import { LocalStorageKeys, ARMApiVersions, LogCategories, ScenarioIds } from './../shared/models/constants';
        ...
        this.subscriptionOptions = info.subscriptions
            .map(e => {
                ...
                return {
                    ...
                    value: e,
                    isSelected: subSelected && count <= ARMApiVersions.MaxSubscriptionBatchSize
                };
            })
