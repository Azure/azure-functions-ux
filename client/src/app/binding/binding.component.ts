...
export class BindingComponent extends FunctionAppContextComponent implements OnDestroy {
  ...
  @Output()
  remove = new EventEmitter<UIFunctionBinding>();
  @Output()
  update = new EventEmitter<UIFunctionBinding>();
  @Output()
  validChange = new EventEmitter<BindingComponent>();
  @Output()
  hasInputsToShowEvent = new EventEmitter<boolean>();
  @Output()
  go = new EventEmitter<Action>();
  @Output()
  ...
  constructor(
    ...
    super('binding', _functionAppService, broadcastService, functionService);
  ...
  setup(): Subscription {
    return this.viewInfoEvents
      ...
      .subscribe(appSettingsResult => {
        // TODO: [alrod] handle error
        this._appSettings = appSettingsResult.isSuccessful ? appSettingsResult.result.properties : {};
        this.filterWarnings();
        this._updateBinding();
      });
  }
