...
export class TableCellComponent {
  ...
  @ViewChild('boundaryLeft')
  boundaryLeft: ElementRef;
  @ViewChild('boundaryRight')
  boundaryRight: ElementRef;

  public isFirstCell: boolean = false;
  public isLastCell: boolean = false;
  public index: number;

  constructor(private _eref: ElementRef, public parentRow: TableRowComponent) {}
  ...
  public setFocus(scrollIntoView?: boolean): HTMLElement {
    ...
    if (this.parentRow.parentTable.editMode) {
      if (this.boundaryLeft && this.boundaryRight) {
        target =
          this.boundaryLeft.nativeElement === document.activeElement ? this.boundaryRight.nativeElement : this.boundaryLeft.nativeElement;
