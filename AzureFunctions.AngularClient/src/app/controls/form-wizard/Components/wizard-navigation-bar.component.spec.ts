...
describe('WizardNavigationBarComponent', () => {
    ...
    it(
        'should show the first step correctly, after first jumping from the first to the third step ' +
    ...
    it(
        'should show the second step correctly, after first jumping from the first to the third step ' +
    ...
    it('should use the "small" layout when no navigation bar layout is specified', () => {
        ...
        expect(navBar.classes).toEqual({
            ...
            small: true,
            'large-filled': false,
            'large-filled-symbols': false,
            'large-empty': false,
            'large-empty-symbols': false
        });
    });
