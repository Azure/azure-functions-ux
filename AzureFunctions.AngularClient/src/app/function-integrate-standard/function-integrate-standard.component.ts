...
@Component({
    selector: 'function-integrate-standard',
    templateUrl: './function-integrate-standard.component.html',
    styleUrls: ['./function-integrate-standard.component.scss'],
})
export class FunctionIntegrateStandardComponent extends BaseFunctionComponent {
    ...
    constructor(
        ...
        super('function-integrate-standard', injector, DashboardType.FunctionIntegrateDashboard);
    }
