...
gulp.task('replace-environment-variables', cb => {
  ...
  if (minFolderExists) {
    ...
    const config = {
      ...
      githubMooncakeClientId: process.env.githubMooncakeClientId || '',
      githubMooncakeClientSecret: process.env.githubMooncakeClientSecret || '',
      githubFairfaxClientId: process.env.githubFairfaxClientId || '',
      githubFairfaxClientSecret: process.env.githubFairfaxClientSecret || '',
      ...
      githubForCreatesMooncakeClientId: process.env.githubForCreatesMooncakeClientId || '',
      githubForCreatesMooncakeClientSecret: process.env.githubForCreatesMooncakeClientSecret || '',
      githubForCreatesFairfaxClientId: process.env.githubForCreatesFairfaxClientId || '',
      githubForCreatesFairfaxClientSecret: process.env.githubForCreatesFairfaxClientSecret || '',
      HashSalt: hashSalt,
