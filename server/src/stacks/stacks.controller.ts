...
import {
  ...
  validateWebAppStack,
  validateRemoveGitHubActionUnsupported,
} from './validations';
...
export class StacksController {
  ...
  functionAppStacks(
    ...
    @Query('removeGitHubActionUnsupportedStacks') removeGitHubActionUnsupportedStacks?: string
  ) {
    ...
    validateRemoveGitHubActionUnsupported(removeGitHubActionUnsupportedStacks);
    ...
    const removeGitHubActionUnsupported =
      removeGitHubActionUnsupportedStacks && removeGitHubActionUnsupportedStacks.toLowerCase() === 'true';
