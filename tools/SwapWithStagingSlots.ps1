...
Write-Host swapping india site ....
Invoke-AzureRmResourceAction -ResourceGroupName functions-india -ResourceType Microsoft.Web/sites -ResourceName functions-india -Action slotsswap -Parameters $ParametersObject -ApiVersion 2015-08-01 -Force

Write-Host swapping brazil site ....
Invoke-AzureRmResourceAction -ResourceGroupName functions-brazil -ResourceType Microsoft.Web/sites -ResourceName functions-brazil -Action slotsswap -Parameters $ParametersObject -ApiVersion 2015-08-01 -Force

Write-Host swapping france site ....
Invoke-AzureRmResourceAction -ResourceGroupName functions-france -ResourceType Microsoft.Web/sites -ResourceName functions-france -Action slotsswap -Parameters $ParametersObject -ApiVersion 2015-08-01 -Force

Write-Host swapping australia site ....
Invoke-AzureRmResourceAction -ResourceGroupName functions-australia -ResourceType Microsoft.Web/sites -ResourceName functions-australia -Action slotsswap -Parameters $ParametersObject -ApiVersion 2015-08-01 -Force
