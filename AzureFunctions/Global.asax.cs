...
namespace AzureFunctions
{
    public class Global : System.Web.HttpApplication
    {
        ...
        private void RegisterRoutes(HttpConfiguration config)
        {
            ...
            config.Routes.MapHttpRoute("get-version", "api/version", new { controller = "AzureFunctions", action = "GetVersion", authenticated = false }, new { verb = new HttpMethodConstraint(HttpMethod.Get.ToString()) });
