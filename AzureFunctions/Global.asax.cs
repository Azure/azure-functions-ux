...
namespace AzureFunctions
{
    public class Global : System.Web.HttpApplication
    {
        ...
        private void RegisterRoutes(HttpConfiguration config)
        {
            ...
            config.Routes.MapHttpRoute("passthrough", "api/passthrough", new { controller = "AzureFunctions", action = "PassThrough" }, new { verb = new HttpMethodConstraint(HttpMethod.Post.ToString()) });
